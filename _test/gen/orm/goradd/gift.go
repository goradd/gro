...
func (o *Gift) Save(ctx context.Context) error {
	return o.save(ctx)
}

// QueryGifts returns a new query builder.
// See GiftBuilder for doc on how to use the builder.
...
// getGiftInsertFields returns fields and values that will be used for a new record in the database.
...
func getGiftInsertFields(o *giftBase) (fields map[string]interface{}) {
	return o.getInsertFields()
}

// getGiftUpdateFields returns fields and values that will be used to update a current record in
// the database.
// You can add or modify the fields here before they are sent to the database.
func getGiftUpdateFields(o *giftBase) (fields map[string]interface{}) {
	return o.getUpdateFields()
}

// DeleteGift deletes the gift record with primary key pk from the database.
