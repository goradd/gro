...
func (o *employeeInfoBase) PersonId() []byte {
...
func (o *employeeInfoBase) SetPersonId(v []byte) {
...
func LoadEmployeeInfoByPersonId(ctx context.Context, personId []byte, selectNodes ...query.Node) (*EmployeeInfo, error) {
...
// doc: type=EmployeeInfo
func HasEmployeeInfoByPersonId(ctx context.Context, personId []byte) (bool, error) {
	q := queryEmployeeInfos(ctx)
	q = q.Where(op.Equal(node.EmployeeInfo().PersonId(), personId))
	v, err := q.Count()
	return v > 0, err
...
// have personId.
// doc: type=EmployeeInfo
func CountEmployeeInfosByPersonId(ctx context.Context, personId []byte) (int, error) {
	v_personId := personId
	return QueryEmployeeInfos(ctx).
