...
func (o *personWithLockBase) GroLockIsValid() bool {
...
func (o *personWithLockBase) update(ctx context.Context) error {
	...
	err := db.ExecuteTransaction(ctx, d, func() error {
		...
		if len(modifiedFields) != 0 {
			...
			v_groTimestamp = time.Now().UnixMicro()
			modifiedFields["gro_timestamp"] = v_groTimestamp
...
func (o *personWithLockBase) insert(ctx context.Context) (err error) {
	...
	err = db.ExecuteTransaction(ctx, d, func() error {
		...
		newPk := d.Insert(ctx, "person_with_lock", m)
		o.id = newPk
		o._originalPK = newPk
		o.idIsValid = true
