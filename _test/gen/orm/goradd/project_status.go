...
func (e ProjectStatus) String() string {
    switch e {
        case 1: return "ProjectStatusOpen"
        case 2: return "ProjectStatusCancelled"
        case 3: return "ProjectStatusCompleted"
        case 4: return "ProjectStatusPlanned"
        default: return ""
    }
}
...
func (e ProjectStatus) Key() string {
    ...
    switch (e) {
    case ProjectStatusOpen: return "o"
    case ProjectStatusCancelled: return "cancelled"
    case ProjectStatusCompleted: return "comp"
    case ProjectStatusPlanned: return "p"
    }
	return ""
}
...
func ProjectStatusFromKey (key string) ProjectStatus {
	switch key {
    case "o": return ProjectStatusOpen
    case "cancelled": return ProjectStatusCancelled
    case "comp": return ProjectStatusCompleted
    case "p": return ProjectStatusPlanned
	}
...
// ProjectStatusLabel returns the Label values associated with ProjectStatus.
func (e ProjectStatus) Label() string {
	switch e {
	case 0: return ""
	case ProjectStatusOpen: return "Open"
	case ProjectStatusCancelled: return "Cancelled"
	case ProjectStatusCompleted: return "Done"
	case ProjectStatusPlanned: return "Planned"
...
// ProjectStatus returns the  values associated with ProjectStatus.
func (e ProjectStatus) () string {
	switch e {
	case 0: return ""
	case ProjectStatusOpen: return "The project is currently active"
	case ProjectStatusCancelled: return "The project has been canned"
	case ProjectStatusCompleted: return "The project has been completed successfully"
	case ProjectStatusPlanned: return "Project is in the planning stages and has not been assigned a manager"
	default: panic("index out of range")
	}
}

// ProjectStatus returns a slice of all the  values associated with ProjectStatus.
// doc: type=ProjectStatus
...
func (e ProjectStatus) () string {
	switch e {
	case 0: return ""
	case ProjectStatusOpen: return "All projects that we are working on should be in this state"
	case ProjectStatusCancelled: return ""
	case ProjectStatusCompleted: return "Celebrate successes!"
	case ProjectStatusPlanned: return "Get ready"
	default: panic("index out of range")
	}
}
...
// ProjectStatus returns the  values associated with ProjectStatus.
func (e ProjectStatus) () bool {
	switch e {
	case 0: return false
	case ProjectStatusOpen: return true
	case ProjectStatusCancelled: return true
	case ProjectStatusCompleted: return true
	case ProjectStatusPlanned: return false
	default: panic("index out of range")
	}
}
...
// ProjectStatusKey returns the Key values associated with ProjectStatus.
func (e ProjectStatus) Key() string {
	switch e {
	case 0: return ""
	case ProjectStatusOpen: return <nil>
	case ProjectStatusCancelled: return <nil>
	case ProjectStatusCompleted: return <nil>
	case ProjectStatusPlanned: return <nil>
	default: panic("index out of range")
	}
}

// ProjectStatusKeys returns a slice of all the Key values associated with ProjectStatus.
// doc: type=ProjectStatus
func ProjectStatusKeys() []string {
	return []string {
	    <nil>,
	    <nil>,
	    <nil>,
