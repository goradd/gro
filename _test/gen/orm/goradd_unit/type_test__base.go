...
const (
	...
	TypeTest_CreationTime        = `CreationTime`
	TypeTest_ModifiedTime        = `ModifiedTime`
	TypeTest_TestInt             = `TestInt`
	TypeTest_TestUnsigned        = `TestUnsigned`
	TypeTest_TestInt64           = `TestInt64`
	TypeTest_TestUint64          = `TestUint64`
	TypeTest_TestFloat32         = `TestFloat32`
	TypeTest_TestFloat64         = `TestFloat64`
	TypeTest_TestNumeric         = `TestNumeric`
	TypeTest_TestBool            = `TestBool`
	TypeTest_TestUnlimitedString = `TestUnlimitedString`
	TypeTest_TestLimitedString   = `TestLimitedString`
	TypeTest_TestLongstring      = `TestLongstring`
	TypeTest_TestUnlimitedBytes  = `TestUnlimitedBytes`
	TypeTest_TestLimitedBytes    = `TestLimitedBytes`
	TypeTest_TypeLongBytes       = `TypeLongBytes`
)
...
// Start a query by calling QueryTypeTests, which will select all
...
// CountTypeTestsByCreationTime queries the database and returns the number of TypeTest objects that
// have creationTime.
// doc: type=TypeTest
func CountTypeTestsByCreationTime(ctx context.Context, creationTime time.Time) (int, error) {
	return QueryTypeTests(ctx).Where(op.Equal(node.TypeTest().CreationTime(), creationTime)).Count()
}

// CountTypeTestsByModifiedTime queries the database and returns the number of TypeTest objects that
// have modifiedTime.
// doc: type=TypeTest
func CountTypeTestsByModifiedTime(ctx context.Context, modifiedTime time.Time) (int, error) {
	return QueryTypeTests(ctx).Where(op.Equal(node.TypeTest().ModifiedTime(), modifiedTime)).Count()
}
...
// CountTypeTestsByTestUnsigned queries the database and returns the number of TypeTest objects that
// have testUnsigned.
// doc: type=TypeTest
func CountTypeTestsByTestUnsigned(ctx context.Context, testUnsigned uint) (int, error) {
	return QueryTypeTests(ctx).Where(op.Equal(node.TypeTest().TestUnsigned(), testUnsigned)).Count()
}

// CountTypeTestsByTestInt64 queries the database and returns the number of TypeTest objects that
// have testInt64.
// doc: type=TypeTest
func CountTypeTestsByTestInt64(ctx context.Context, testInt64 int64) (int, error) {
	return QueryTypeTests(ctx).Where(op.Equal(node.TypeTest().TestInt64(), testInt64)).Count()
}

// CountTypeTestsByTestUint64 queries the database and returns the number of TypeTest objects that
// have testUint64.
// doc: type=TypeTest
func CountTypeTestsByTestUint64(ctx context.Context, testUint64 uint64) (int, error) {
	return QueryTypeTests(ctx).Where(op.Equal(node.TypeTest().TestUint64(), testUint64)).Count()
}

// CountTypeTestsByTestFloat32 queries the database and returns the number of TypeTest objects that
// have testFloat32.
// doc: type=TypeTest
func CountTypeTestsByTestFloat32(ctx context.Context, testFloat32 float32) (int, error) {
	return QueryTypeTests(ctx).Where(op.Equal(node.TypeTest().TestFloat32(), testFloat32)).Count()
}

// CountTypeTestsByTestFloat64 queries the database and returns the number of TypeTest objects that
// have testFloat64.
// doc: type=TypeTest
func CountTypeTestsByTestFloat64(ctx context.Context, testFloat64 float64) (int, error) {
	return QueryTypeTests(ctx).Where(op.Equal(node.TypeTest().TestFloat64(), testFloat64)).Count()
}

// CountTypeTestsByTestNumeric queries the database and returns the number of TypeTest objects that
// have testNumeric.
// doc: type=TypeTest
func CountTypeTestsByTestNumeric(ctx context.Context, testNumeric string) (int, error) {
	return QueryTypeTests(ctx).Where(op.Equal(node.TypeTest().TestNumeric(), testNumeric)).Count()
}

// CountTypeTestsByTestBool queries the database and returns the number of TypeTest objects that
// have testBool.
// doc: type=TypeTest
func CountTypeTestsByTestBool(ctx context.Context, testBool bool) (int, error) {
	return QueryTypeTests(ctx).Where(op.Equal(node.TypeTest().TestBool(), testBool)).Count()
}

// CountTypeTestsByTestUnlimitedString queries the database and returns the number of TypeTest objects that
// have testUnlimitedString.
// doc: type=TypeTest
func CountTypeTestsByTestUnlimitedString(ctx context.Context, testUnlimitedString string) (int, error) {
	return QueryTypeTests(ctx).Where(op.Equal(node.TypeTest().TestUnlimitedString(), testUnlimitedString)).Count()
}

// CountTypeTestsByTestLimitedString queries the database and returns the number of TypeTest objects that
// have testLimitedString.
// doc: type=TypeTest
func CountTypeTestsByTestLimitedString(ctx context.Context, testLimitedString string) (int, error) {
	return QueryTypeTests(ctx).Where(op.Equal(node.TypeTest().TestLimitedString(), testLimitedString)).Count()
}

// CountTypeTestsByTestLongstring queries the database and returns the number of TypeTest objects that
// have testLongstring.
// doc: type=TypeTest
func CountTypeTestsByTestLongstring(ctx context.Context, testLongstring string) (int, error) {
	return QueryTypeTests(ctx).Where(op.Equal(node.TypeTest().TestLongstring(), testLongstring)).Count()
}

// CountTypeTestsByTestUnlimitedBytes queries the database and returns the number of TypeTest objects that
// have testUnlimitedBytes.
// doc: type=TypeTest
func CountTypeTestsByTestUnlimitedBytes(ctx context.Context, testUnlimitedBytes []byte) (int, error) {
	return QueryTypeTests(ctx).Where(op.Equal(node.TypeTest().TestUnlimitedBytes(), testUnlimitedBytes)).Count()
}

// CountTypeTestsByTestLimitedBytes queries the database and returns the number of TypeTest objects that
// have testLimitedBytes.
// doc: type=TypeTest
func CountTypeTestsByTestLimitedBytes(ctx context.Context, testLimitedBytes []byte) (int, error) {
	return QueryTypeTests(ctx).Where(op.Equal(node.TypeTest().TestLimitedBytes(), testLimitedBytes)).Count()
}

// CountTypeTestsByTypeLongBytes queries the database and returns the number of TypeTest objects that
// have typeLongBytes.
// doc: type=TypeTest
func CountTypeTestsByTypeLongBytes(ctx context.Context, typeLongBytes []byte) (int, error) {
	return QueryTypeTests(ctx).Where(op.Equal(node.TypeTest().TypeLongBytes(), typeLongBytes)).Count()
}
