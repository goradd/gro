...
// This is the implementation file for the RootL ORM object.
...
func (o *RootL) String() string {
	...
	return fmt.Sprintf("RootL %v", o.PrimaryKey())
}
...
func queryRootLs(ctx context.Context) *RootLBuilder {
	...
	return newRootLBuilder(ctx)
}

// getRootLInsertFields returns fields and values that will be used for a new record in the database.
...
func getRootLInsertFields(o *rootLBase) (fields map[string]interface{}) {
	return o.getInsertFields()
}

// getRootLUpdateFields returns fields and values that will be used to update a current record in
// the database.
// You can add or modify the fields here before they are sent to the database.
func getRootLUpdateFields(o *rootLBase) (fields map[string]interface{}) {
...
func init() {
	gob.RegisterName("goradd_unitRootL", new(RootL))
}
