...
func TestTypeTest_ReferenceLoad(t *testing.T) {
	...
	// test eager loading
	obj3, _ := LoadTypeTest(ctx, obj.PrimaryKey(), node.TypeTest().ID(),
		node.TypeTest().Date(),
		node.TypeTest().Time(),
		node.TypeTest().DateTime(),
		node.TypeTest().CreationTime(),
		node.TypeTest().ModifiedTime(),
		node.TypeTest().TestInt(),
		node.TypeTest().TestUnsigned(),
		node.TypeTest().TestInt64(),
		node.TypeTest().TestUint64(),
		node.TypeTest().TestFloat32(),
		node.TypeTest().TestFloat64(),
		node.TypeTest().TestNumeric(),
		node.TypeTest().TestBool(),
		node.TypeTest().TestUnlimitedString(),
		node.TypeTest().TestLimitedString(),
		node.TypeTest().TestLongstring(),
		node.TypeTest().TestUnlimitedBytes(),
		node.TypeTest().TestLimitedBytes(),
		node.TypeTest().TypeLongBytes(),
	)
...
func TestTypeTest_ReferenceUpdateOldObjects(t *testing.T) {
	...
	obj2, _ := LoadTypeTest(ctx, obj.PrimaryKey(), node.TypeTest().ID(),
		node.TypeTest().Date(),
		node.TypeTest().Time(),
		node.TypeTest().DateTime(),
		node.TypeTest().CreationTime(),
