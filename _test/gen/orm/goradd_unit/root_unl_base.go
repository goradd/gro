...
func LoadRootUnl(ctx context.Context, pk string, selectNodes ...query.Node) (*RootUnl, error) {
...
// doc: type=RootUnl
func HasRootUnl(ctx context.Context, pk string) (bool, error) {
