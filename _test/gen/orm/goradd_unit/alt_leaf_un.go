...
// This is the implementation file for the AltLeafUn ORM object.
...
func (o *AltLeafUn) String() string {
	...
	return fmt.Sprintf("AltLeafUn %v", o.PrimaryKey())
}
...
// QueryAltLeafUns returns a new query builder.
// See AltLeafUnBuilder for doc on how to use the builder.
...
// queryAltLeafUns creates a new builder and is the central spot where all queries are directed.
...
func queryAltLeafUns(ctx context.Context) *AltLeafUnBuilder {
	...
	return newAltLeafUnBuilder(ctx)
}

// getAltLeafUnInsertFields returns fields and values that will be used for a new record in the database.
...
func getAltLeafUnInsertFields(o *altLeafUnBase) (fields map[string]interface{}) {
	return o.getInsertFields()
}

// getAltLeafUnUpdateFields returns fields and values that will be used to update a current record in
// the database.
// You can add or modify the fields here before they are sent to the database.
func getAltLeafUnUpdateFields(o *altLeafUnBase) (fields map[string]interface{}) {
	return o.getUpdateFields()
}

// DeleteAltLeafUn deletes the alt_leaf_un record with primary key pk from the database.
// Note that you can also delete loaded AltLeafUn objects by calling Delete on them.
...
func DeleteAltLeafUn(ctx context.Context, pk string) error {
	return deleteAltLeafUn(ctx, pk)
}

func init() {
	gob.RegisterName("goradd_unitAltLeafUn", new(AltLeafUn))
}
