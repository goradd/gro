...
// The LeafUnBuilder uses the query.BuilderI interface to build a query.
// All query operations go through this query builder.
// End a query by calling either Load, LoadCursor, Get, Count, or Delete
type LeafUnBuilder interface {
	// Join(alias string, joinedTable query.Node, condition query.Node) LeafUnBuilder
...
func (o *leafUnBase) update(ctx context.Context) error {
	...
	o.resetDirtyStatus()
	if len(modifiedFields) != 0 {
		broadcast.Update(ctx, "goradd_unit", "leaf_un", o._originalPK, all.SortedKeys(modifiedFields)...)
	}
...
func (o *leafUnBase) Delete(ctx context.Context) (err error) {
	...
	d := Database()
	return d.Delete(ctx, "leaf_un", map[string]any{"ID": o.id})
