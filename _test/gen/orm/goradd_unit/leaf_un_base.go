...
const LeafUnRootUnIDMaxLength = 32 // The number of runes the column can hold
...
func (o *leafUnBase) SetPrimaryKey(v string) {
	if o._restored {
...
func (o *leafUnBase) SetRootUnID(v string) {
	if utf8.RuneCountInString(v) > LeafUnRootUnIDMaxLength {
		panic("attempted to set LeafUn.RootUnID to a value larger than its maximum length in runes")
	}
	if o._restored &&
	...
	if o.rootUn != nil &&
		o.rootUnID != o.rootUn.PrimaryKey() {
		o.rootUn = nil
	}
}
...
func (o *leafUnBase) LoadRootUn(ctx context.Context) (*RootUn, error) {
	...
	if o.rootUn == nil {
		...
		// Load and cache
		o.rootUn, err = LoadRootUn(ctx, o.rootUnID)
	}
	return o.rootUn, err
}

// SetRootUn sets the value of RootUn in the object, to be saved later using the Save() function.
func (o *leafUnBase) SetRootUn(rootUn *RootUn) {
	if rootUn == nil {
		panic("Cannot set RootUn to a nil value since RootUnID is not nullable.")
	} else {
		o.rootUn = rootUn
		o.rootUnIDIsLoaded = true
		if o.rootUnID != rootUn.PrimaryKey() {
...
func LoadLeafUn(ctx context.Context, pk string, selectNodes ...query.Node) (*LeafUn, error) {
	return queryLeafUns(ctx).
		Where(op.Equal(node.LeafUn().ID(), pk.id)).
		Select(selectNodes...).
		Get()
}
...
// doc: type=LeafUn
func HasLeafUn(ctx context.Context, pk string) (bool, error) {
...
// LoadLeafUnBy queries for a single LeafUn object by the given unique index values.
...
func LoadLeafUnBy(ctx context.Context, rootUnID string, selectNodes ...query.Node) (*LeafUn, error) {
	q := queryLeafUns(ctx)
	q = q.Where(op.Equal(node.LeafUn().RootUnID(), rootUnID))
	return q.Select(selectNodes...).Get()
}

// HasLeafUnBy returns true if the
// given unique index values exist in the database.
// doc: type=LeafUn
func HasLeafUnBy(ctx context.Context, rootUnID string) (bool, error) {
	q := queryLeafUns(ctx)
	q = q.Where(op.Equal(node.LeafUn().RootUnID(), rootUnID))
	v, err := q.Count()
	return v > 0, err
...
// CountLeafUnsBy queries the database and returns the number of LeafUn objects that
// have rootUnID.
// doc: type=LeafUn
func CountLeafUnsBy(ctx context.Context, rootUnID string) (int, error) {
	v_rootUnID := rootUnID
	return QueryLeafUns(ctx).
...
func (o *leafUnBase) unpack(m map[string]interface{}, objThis *LeafUn) {
	...
	if v, ok := m["root_un_id"]; ok && v != nil {
		if o.rootUnID, ok = v.(string); ok {
			o.rootUnIDIsLoaded = true
			o.rootUnIDIsDirty = false
		} else {
	...
	if v, ok := m["RootUn"]; ok {
		if rootUn, ok2 := v.(map[string]any); ok2 {
			o.rootUn = new(RootUn)
			o.rootUn.unpack(rootUn, o.rootUn)
			o.rootUnIDIsLoaded = true
			o.rootUnIDIsDirty = false
		} else {
...
func (o *leafUnBase) update(ctx context.Context) error {
	...
	err := db.WithTransaction(ctx, d, func(ctx context.Context) error {
		...
		if o.rootUn != nil {
			if err := o.rootUn.Save(ctx); err != nil {
				return err
			}
			o.SetRootUnID(o.rootUn.PrimaryKey())
		}
...
func (o *leafUnBase) insert(ctx context.Context) (err error) {
	...
	err = db.WithTransaction(ctx, d, func(context.Context) error {
		...
		if !o.rootUnIDIsLoaded {
			panic("a value for RootUnID is required, and there is no default value. Call SetRootUnID() before inserting the record.")
		}
...
func (o *leafUnBase) encodeTo(enc db.Encoder) error {
	...
	if o.rootUn == nil {
		...
		if err := enc.Encode(o.rootUn); err != nil {
			return fmt.Errorf("error encoding LeafUn.rootUn: %w", err)
		}
	}
...
func (o *leafUnBase) decodeFrom(dec db.Decoder) (err error) {
	...
	if err = dec.Decode(&isPtr); err != nil {
		return fmt.Errorf("error decoding LeafUn.rootUn isPtr: %w", err)
	}
	if isPtr {
		if err = dec.Decode(&o.rootUn); err != nil {
			return fmt.Errorf("error decoding LeafUn.rootUn: %w", err)
		}
	}
	if err = dec.Decode(&isPtr); err != nil {
