...
type forwardCascadeNodeEncoded struct {
	RefNode query.ReferenceNodeI
}

// GobEncode makes the node serializable.
// doc:hide
func (n *ForwardCascadeNode) GobEncode() (data []byte, err error) {
	var buf bytes.Buffer
	e := gob.NewEncoder(&buf)

	s := forwardCascadeNodeEncoded{
...
// doc: hide
func (n *ForwardCascadeNode) GobDecode(data []byte) (err error) {
	buf := bytes.NewBuffer(data)
	dec := gob.NewDecoder(buf)

	var s forwardCascadeNodeEncoded
...
func init() {
	gob.Register(&ForwardCascadeNode{})
}
