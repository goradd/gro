...
// See DoubleIndexBuilder for doc on how to use the builder.
...
// getDoubleIndexInsertFields returns fields and values that will be used for a new record in the database.
...
func getDoubleIndexInsertFields(o *doubleIndexBase) (fields map[string]interface{}) {
	return o.getInsertFields()
}

// getDoubleIndexUpdateFields returns fields and values that will be used to update a current record in
// the database.
// You can add or modify the fields here before they are sent to the database.
func getDoubleIndexUpdateFields(o *doubleIndexBase) (fields map[string]interface{}) {
