...
// This is the implementation file for the RootUnl ORM object.
...
func (o *RootUnl) String() string {
	...
	return fmt.Sprintf("RootUnl %v", o.PrimaryKey())
}
...
// QueryRootUnls returns a new query builder.
// See RootUnlBuilder for doc on how to use the builder.
func QueryRootUnls(ctx context.Context) RootUnlBuilder {
	return queryRootUnls(ctx)
}

// queryRootUnls creates a new builder and is the central spot where all queries are directed.
...
func queryRootUnls(ctx context.Context) RootUnlBuilder {
	...
	return newRootUnlBuilder(ctx)
}

// getRootUnlInsertFields returns fields and values that will be used for a new record in the database.
...
func getRootUnlInsertFields(o *rootUnlBase) (fields map[string]interface{}) {
	return o.getInsertFields()
}

// getRootUnlUpdateFields returns fields and values that will be used to update a current record in
// the database.
// You can add or modify the fields here before they are sent to the database.
func getRootUnlUpdateFields(o *rootUnlBase) (fields map[string]interface{}) {
	return o.getUpdateFields()
}

// DeleteRootUnl deletes the root_unl record with primary key pk from the database.
// Note that you can also delete loaded RootUnl objects by calling Delete on them.
...
func DeleteRootUnl(ctx context.Context, pk string) error {
	return deleteRootUnl(ctx, pk)
}

func init() {
	gob.RegisterName("goradd_unitRootUnl", new(RootUnl))
}
