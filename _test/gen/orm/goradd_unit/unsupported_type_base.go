...
func LoadUnsupportedType(ctx context.Context, typeSerial uint64, selectNodes ...query.Node) (*UnsupportedType, error) {
...
// doc: type=UnsupportedType
func HasUnsupportedType(ctx context.Context, typeSerial uint64) (bool, error) {
