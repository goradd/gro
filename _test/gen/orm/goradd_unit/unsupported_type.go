...
func (o *UnsupportedType) String() string {
	...
	pk += fmt.Sprintf(" %v", o.TypeSerial())

	return "UnsupportedType" + pk
}
...
// See UnsupportedTypeBuilder for doc on how to use the builder.
...
// getUnsupportedTypeInsertFields returns fields and values that will be used for a new record in the database.
...
func getUnsupportedTypeInsertFields(o *unsupportedTypeBase) (fields map[string]interface{}) {
	return o.getInsertFields()
}

// getUnsupportedTypeUpdateFields returns fields and values that will be used to update a current record in
// the database.
// You can add or modify the fields here before they are sent to the database.
func getUnsupportedTypeUpdateFields(o *unsupportedTypeBase) (fields map[string]interface{}) {
