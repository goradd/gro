...
func ClearAll(ctx context.Context) {
	...
	_ = db.Delete(ctx, "leaf_nl_assn", nil)

	_ = db.Delete(ctx, "leaf_unl", nil)
	_ = db.Delete(ctx, "leaf_un", nil)
	_ = db.Delete(ctx, "leaf_ul", nil)
	_ = db.Delete(ctx, "leaf_u", nil)
	_ = db.Delete(ctx, "leaf_nl", nil)
	_ = db.Delete(ctx, "leaf_n", nil)
	_ = db.Delete(ctx, "leaf_l", nil)
	_ = db.Delete(ctx, "leaf", nil)
	_ = db.Delete(ctx, "unsupported_type", nil)
	_ = db.Delete(ctx, "type_test", nil)
	_ = db.Delete(ctx, "root_unl", nil)
	_ = db.Delete(ctx, "root_un", nil)
	_ = db.Delete(ctx, "root_ul", nil)
	_ = db.Delete(ctx, "root_u", nil)
	_ = db.Delete(ctx, "root_nl", nil)
	_ = db.Delete(ctx, "root_n", nil)
	_ = db.Delete(ctx, "root_l", nil)
