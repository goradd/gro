...
// Copy copies all valid fields to a new ForwardNull object.
...
// See [ForwardNullsBuilder.Select] for more info.
func LoadForwardNull(ctx context.Context, id string, selectNodes ...query.Node) *ForwardNull {
...
type ForwardNullBuilder interface {
	...
	OrderBy(nodes ...query.Sorter) ForwardNullBuilder

	// Limit will return a subset of the data, limited to the offset and number of rows specified.
	// For large data sets and specific types of queries, this can be slow, because it will perform
	// the entire query before computing the limit.
	// You cannot limit a query that has embedded arrays.
	Limit(maxRowCount int, offset int) ForwardNullBuilder
	...
	Select(nodes ...query.Node) ForwardNullBuilder
	...
	GroupBy(nodes ...query.Node) ForwardNullBuilder

	// Having does additional filtering on the results of the query after the query is performed.
	Having(node query.Node) ForwardNullBuilder

	// Load terminates the query builder, performs the query, and returns a slice of ForwardNull objects.
...
type forwardNullQueryBuilder struct {
	builder *query.Builder
}

func newForwardNullBuilder(ctx context.Context) ForwardNullBuilder {
	b := forwardNullQueryBuilder{
		builder: query.NewBuilder(ctx, node.ForwardNull()),
	}
	return &b
}
...
// If an error occurs, or no results are found, a nil is returned.
// In the case of an error, the error is returned in the context.
func (b *forwardNullQueryBuilder) Get() *ForwardNull {
	results := b.Load()
...
func (b *forwardNullQueryBuilder) Join(alias string, joinedTable query.Node, condition query.Node) ForwardNullBuilder {
    if query.RootNode(n).TableName_() != "forward_null" {
        panic("you can only join a node that is rooted at node.ForwardNull()")
    }
...
// Where adds a condition to filter what gets selected.
// Calling Where multiple times will AND the conditions together.
func (b *forwardNullQueryBuilder) Where(c query.Node) ForwardNullBuilder {
	b.builder.Where(c)
	return b
}
...
// By default, the given nodes are sorted in ascending order.
// Add Descending() to the node to specify that it should be sorted in descending order.
func (b *forwardNullQueryBuilder) OrderBy(nodes ...query.Sorter) ForwardNullBuilder {
...
// the entire query before computing the limit.
// You cannot limit a query that has embedded arrays.
func (b *forwardNullQueryBuilder) Limit(maxRowCount int, offset int) ForwardNullBuilder {
	b.builder.Limit(maxRowCount, offset)
	return b
}

// Select specifies what specific columns will be loaded with data.
// By default, all the columns of the forward_null table will be queried and loaded.
// If nodes contains columns from the forward_null table, that will limit the columns queried and loaded to only those columns.
...
func (b *forwardNullQueryBuilder) Select(nodes ...query.Node) ForwardNullBuilder {
...
func (b *forwardNullQueryBuilder) Distinct() ForwardNullBuilder {
	b.builder.Distinct()
	return b
}

// GroupBy controls how results are grouped when using aggregate functions with Calculation.
func (b *forwardNullQueryBuilder) GroupBy(nodes ...query.Node) ForwardNullBuilder {
	b.builder.GroupBy(nodes...)
	return b
}

// Having does additional filtering on the results of the query after the query is performed.
func (b *forwardNullQueryBuilder) Having(node query.Node) ForwardNullBuilder {
...
// You MUST include what you are selecting by adding Calculation or Select functions on the subquery builder.
// Generally you would use this as a node to a Calculation function on the surrounding query builder.
func (b *forwardNullQueryBuilder)  Subquery() *query.SubqueryNode {
...
func (o *forwardNullBase) Save(ctx context.Context) error {
	if o._restored {
		return o.update(ctx)
	} else {
		return o.insert(ctx)
...
func (o *forwardNullBase) update(ctx context.Context) error {
	if !o._restored {
	...
	err := db.ExecuteTransaction(ctx, d, func() error {
		...
		if len(modifiedFields) != 0 {
			err := d.Update(ctx, "forward_null", "id", o._originalPK, modifiedFields, "", 0)
			if err != nil {
				return err
			}
		}
...
func (o *forwardNullBase) insert(ctx context.Context) (err error) {
	d := Database()
	err = db.ExecuteTransaction(ctx, d, func() error {
...
func (o *forwardNullBase) Delete(ctx context.Context) (err error) {
	if !o._restored {
...
func deleteForwardNull(ctx context.Context, pk string) error {
...
func (o *forwardNullBase) MarshalBinary() ([]byte, error) {
	...
	if err := encoder.Encode(o.id); err != nil {
		return nil, fmt.Errorf("error encoding ForwardNull.id: %w", err)
	}
	if err := encoder.Encode(o.idIsValid); err != nil {
		return nil, fmt.Errorf("error encoding ForwardNull.idIsValid: %w", err)
	}

	if err := encoder.Encode(o.name); err != nil {
		return nil, fmt.Errorf("error encoding ForwardNull.name: %w", err)
	}
	if err := encoder.Encode(o.nameIsValid); err != nil {
		return nil, fmt.Errorf("error encoding ForwardNull.nameIsValid: %w", err)
	}
	if err := encoder.Encode(o.nameIsDirty); err != nil {
		return nil, fmt.Errorf("error encoding ForwardNull.nameIsDirty: %w", err)
	}

	if err := encoder.Encode(o.reverseID); err != nil {
		return nil, fmt.Errorf("error encoding ForwardNull.reverseID: %w", err)
	}
	if err := encoder.Encode(o.reverseIDIsNull); err != nil {
		return nil, fmt.Errorf("error encoding ForwardNull.reverseIDIsNull: %w", err)
	}
	if err := encoder.Encode(o.reverseIDIsValid); err != nil {
		return nil, fmt.Errorf("error encoding ForwardNull.reverseIDIsValid: %w", err)
	}
	if err := encoder.Encode(o.reverseIDIsDirty); err != nil {
		return nil, fmt.Errorf("error encoding ForwardNull.reverseIDIsDirty: %w", err)
	}
	...
	if o.objReverse == nil {
		...
		if err := encoder.Encode(o.objReverse); err != nil {
			return nil, fmt.Errorf("error encoding ForwardNull.objReverse: %w", err)
		}
	}
	...
	if o._aliases == nil {
		...
		if err := encoder.Encode(o._aliases); err != nil {
			return nil, fmt.Errorf("error encoding ForwardNull._aliases: %w", err)
		}
	}

	if err := encoder.Encode(o._restored); err != nil {
		return nil, fmt.Errorf("error encoding ForwardNull._restored: %w", err)
	}
	if err := encoder.Encode(o._originalPK); err != nil {
		return nil, fmt.Errorf("error encoding ForwardNull._originalPK: %w", err)
	}
...
func (o *forwardNullBase) UnmarshalBinary(data []byte) (err error) {
	...
	if err = dec.Decode(&o.id); err != nil {
		return fmt.Errorf("error decoding ForwardNull.id: %w", err)
	}
	if err = dec.Decode(&o.idIsValid); err != nil {
		return fmt.Errorf("error decoding ForwardNull.idIsValid: %w", err)
	}

	if err = dec.Decode(&o.name); err != nil {
		return fmt.Errorf("error decoding ForwardNull.name: %w", err)
	}
	if err = dec.Decode(&o.nameIsValid); err != nil {
		return fmt.Errorf("error decoding ForwardNull.nameIsValid: %w", err)
	}
	if err = dec.Decode(&o.nameIsDirty); err != nil {
		return fmt.Errorf("error decoding ForwardNull.nameIsDirty: %w", err)
	}

	if err = dec.Decode(&o.reverseID); err != nil {
		return fmt.Errorf("error decoding ForwardNull.reverseID: %w", err)
	}
	if err = dec.Decode(&o.reverseIDIsNull); err != nil {
		return fmt.Errorf("error decoding ForwardNull.reverseIDIsNull: %w", err)
	}
	if err = dec.Decode(&o.reverseIDIsValid); err != nil {
		return fmt.Errorf("error decoding ForwardNull.reverseIDIsValid: %w", err)
	}
	if err = dec.Decode(&o.reverseIDIsDirty); err != nil {
		return fmt.Errorf("error decoding ForwardNull.reverseIDIsDirty: %w", err)
	}

	if err = dec.Decode(&isPtr); err != nil {
		return fmt.Errorf("error decoding ForwardNull.objReverse isPtr: %w", err)
	}
	if isPtr {
		if err = dec.Decode(&o.objReverse); err != nil {
			return fmt.Errorf("error decoding ForwardNull.objReverse: %w", err)
		}
	}
	return
}
