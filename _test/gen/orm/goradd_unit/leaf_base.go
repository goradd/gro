...
func (o *leafBase) unpack(m map[string]interface{}, objThis *Leaf) {
	...
	if v, ok := m["Root"]; ok {
		if objRoot, ok2 := v.(map[string]any); ok2 {
			o.objRoot = new(Root)
			o.objRoot.unpack(objRoot, o.objRoot)
			o.rootIDIsLoaded = true
			o.rootIDIsDirty = false
		} else {
...
func (o *leafBase) update(ctx context.Context) error {
	...
	err := db.ExecuteTransaction(ctx, d, func() error {
		...
		if o.objRoot != nil {
			if err := o.objRoot.Save(ctx); err != nil {
				return err
			}
			o.SetRootID(o.objRoot.PrimaryKey())
		}
...
func (o *leafBase) IsDirty() (dirty bool) {
	dirty = o.idIsDirty ||
		o.nameIsDirty ||
		o.rootIDIsDirty ||
		(o.objRoot != nil && o.objRoot.IsDirty())
...
func (o *leafBase) encodeTo(enc db.Encoder) error {
	...
	if o.objRoot == nil {
		...
		if err := enc.Encode(o.objRoot); err != nil {
			return fmt.Errorf("error encoding Leaf.objRoot: %w", err)
		}
	}
...
func (o *leafBase) decodeFrom(dec db.Decoder) (err error) {
	...
	if err = dec.Decode(&isPtr); err != nil {
		return fmt.Errorf("error decoding Leaf.objRoot isPtr: %w", err)
	}
	if isPtr {
		if err = dec.Decode(&o.objRoot); err != nil {
			return fmt.Errorf("error decoding Leaf.objRoot: %w", err)
		}
	}
	if err = dec.Decode(&isPtr); err != nil {
...
func (o *leafBase) MarshalStringMap() map[string]interface{} {
	...
	if val := o.objRoot; val != nil {
		v["root"] = val.MarshalStringMap()
	} else if o.rootIDIsLoaded {
		v["rootID"] = o.rootID
	}
