...
func (o *forwardCascadeBase) SetName(v string) {
	if utf8.RuneCountInString(v) > ForwardCascadeNameMaxLength {
...
func (o *forwardCascadeBase) SetReverseID(v string) {
	if o._restored &&
...
func (o *forwardCascadeBase) SetReverseIDToNull() {
...
// See [ForwardCascadesBuilder.Select] for more info.
func LoadForwardCascade(ctx context.Context, id string, selectNodes ...query.Node) *ForwardCascade {
...
type ForwardCascadeBuilder interface {
	// Join(alias string, joinedTable query.Node, condition query.Node) ForwardCascadeBuilder
...
func newForwardCascadeBuilder(ctx context.Context) ForwardCascadeBuilder {
	b := forwardCascadeQueryBuilder{
		builder: query.NewBuilder(ctx, node.ForwardCascade()),
	}
	return &b
}
...
func (b *forwardCascadeQueryBuilder) Join(alias string, joinedTable query.Node, condition query.Node) ForwardCascadeBuilder {
...
// By default, all the columns of the forward_cascade table will be queried and loaded.
// If nodes contains columns from the forward_cascade table, that will limit the columns queried and loaded to only those columns.
...
func (b *forwardCascadeQueryBuilder) Calculation(base query.TableNodeI, alias string, operation query.OperationNodeI) ForwardCascadeBuilder {
...
// To not count NULL values, use Where in the builder with a NotNull operation.
// To count distinct combinations of items, call Distinct() on the builder.
func (b *forwardCascadeQueryBuilder) Count() int {
...
func CountForwardCascadeByID(ctx context.Context, id string) int {
	return queryForwardCascades(ctx).Where(op.Equal(node.ForwardCascade().ID(), id)).Count()
}
...
func CountForwardCascadeByName(ctx context.Context, name string) int {
	return queryForwardCascades(ctx).Where(op.Equal(node.ForwardCascade().Name(), name)).Count()
}
...
func CountForwardCascadeByReverseID(ctx context.Context, reverseID string) int {
	...
	return queryForwardCascades(ctx).Where(op.Equal(node.ForwardCascade().ReverseID(), reverseID)).Count()
}
...
func (o *forwardCascadeBase) MarshalBinary() ([]byte, error) {
	...
	if err := encoder.Encode(o.id); err != nil {
		return nil, fmt.Errorf("error encoding ForwardCascade.id: %w", err)
	}
	if err := encoder.Encode(o.idIsValid); err != nil {
		return nil, fmt.Errorf("error encoding ForwardCascade.idIsValid: %w", err)
	}
	if err := encoder.Encode(o.idIsDirty); err != nil {
		return nil, fmt.Errorf("error encoding ForwardCascade.idIsDirty: %w", err)
	}

	if err := encoder.Encode(o.name); err != nil {
		return nil, fmt.Errorf("error encoding ForwardCascade.name: %w", err)
	}
	if err := encoder.Encode(o.nameIsValid); err != nil {
		return nil, fmt.Errorf("error encoding ForwardCascade.nameIsValid: %w", err)
	}
	if err := encoder.Encode(o.nameIsDirty); err != nil {
		return nil, fmt.Errorf("error encoding ForwardCascade.nameIsDirty: %w", err)
	}

	if err := encoder.Encode(o.reverseID); err != nil {
		return nil, fmt.Errorf("error encoding ForwardCascade.reverseID: %w", err)
	}
	if err := encoder.Encode(o.reverseIDIsNull); err != nil {
		return nil, fmt.Errorf("error encoding ForwardCascade.reverseIDIsNull: %w", err)
	}
	if err := encoder.Encode(o.reverseIDIsValid); err != nil {
		return nil, fmt.Errorf("error encoding ForwardCascade.reverseIDIsValid: %w", err)
	}
	if err := encoder.Encode(o.reverseIDIsDirty); err != nil {
		return nil, fmt.Errorf("error encoding ForwardCascade.reverseIDIsDirty: %w", err)
	}
	...
	if o.objReverse == nil {
		...
		if err := encoder.Encode(o.objReverse); err != nil {
			return nil, fmt.Errorf("error encoding ForwardCascade.objReverse: %w", err)
		}
	}
	...
	if o._aliases == nil {
		...
		if err := encoder.Encode(o._aliases); err != nil {
			return nil, fmt.Errorf("error encoding ForwardCascade._aliases: %w", err)
		}
	}

	if err := encoder.Encode(o._restored); err != nil {
		return nil, fmt.Errorf("error encoding ForwardCascade._restored: %w", err)
	}
	if err := encoder.Encode(o._originalPK); err != nil {
		return nil, fmt.Errorf("error encoding ForwardCascade._originalPK: %w", err)
	}
...
func (o *forwardCascadeBase) UnmarshalBinary(data []byte) (err error) {
	...
	if err = dec.Decode(&o.id); err != nil {
		return fmt.Errorf("error decoding ForwardCascade.id: %w", err)
	}
	if err = dec.Decode(&o.idIsValid); err != nil {
		return fmt.Errorf("error decoding ForwardCascade.idIsValid: %w", err)
	}
	if err = dec.Decode(&o.idIsDirty); err != nil {
		return fmt.Errorf("error decoding ForwardCascade.idIsDirty: %w", err)
	}

	if err = dec.Decode(&o.name); err != nil {
		return fmt.Errorf("error decoding ForwardCascade.name: %w", err)
	}
	if err = dec.Decode(&o.nameIsValid); err != nil {
		return fmt.Errorf("error decoding ForwardCascade.nameIsValid: %w", err)
	}
	if err = dec.Decode(&o.nameIsDirty); err != nil {
		return fmt.Errorf("error decoding ForwardCascade.nameIsDirty: %w", err)
	}

	if err = dec.Decode(&o.reverseID); err != nil {
		return fmt.Errorf("error decoding ForwardCascade.reverseID: %w", err)
	}
	if err = dec.Decode(&o.reverseIDIsNull); err != nil {
		return fmt.Errorf("error decoding ForwardCascade.reverseIDIsNull: %w", err)
	}
	if err = dec.Decode(&o.reverseIDIsValid); err != nil {
		return fmt.Errorf("error decoding ForwardCascade.reverseIDIsValid: %w", err)
	}
	if err = dec.Decode(&o.reverseIDIsDirty); err != nil {
		return fmt.Errorf("error decoding ForwardCascade.reverseIDIsDirty: %w", err)
	}

	if err = dec.Decode(&isPtr); err != nil {
		return fmt.Errorf("error decoding ForwardCascade.objReverse isPtr: %w", err)
	}
	if isPtr {
		if err = dec.Decode(&o.objReverse); err != nil {
			return fmt.Errorf("error decoding ForwardCascade.objReverse: %w", err)
		}
	}
	return
}
