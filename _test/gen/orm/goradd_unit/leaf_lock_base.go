...
// LeafLockBase is embedded in a LeafLock object and provides the ORM access to the database.
// The member variables of the structure are private and should not normally be accessed by the LeafLock embedder.
// Instead, use the accessor functions.
type leafLockBase struct {
	id              string
	idIsLoaded      bool
	idIsDirty       bool
	name            string
...
func (o *leafLockBase) PrimaryKey() string {
	return o.id
}

// OriginalPrimaryKey returns the value of the primary key that was originally loaded into the object when it was
// read from the database.
func (o *leafLockBase) OriginalPrimaryKey() string {
	return o._originalPK
}

// Copy copies most fields to a new LeafLock object.
...
func (o *leafLockBase) Copy() (newObject *LeafLock) {
...
func (o *leafLockBase) IDIsLoaded() bool {
	return o.idIsLoaded
}
...
func (o *leafLockBase) SetID(v string) {
	if o._restored {
...
func (o *leafLockBase) Name() string {
...
func (o *leafLockBase) NameIsLoaded() bool {
...
func (o *leafLockBase) SetName(v string) {
	if utf8.RuneCountInString(v) > LeafLockNameMaxLength {
		panic("attempted to set LeafLock.Name to a value larger than its maximum length in runes")
	}
	if o._restored &&
...
func (o *leafLockBase) IsNew() bool {
	return !o._restored
}
...
type LeafLockBuilder interface {
	// Join(alias string, joinedTable query.Node, condition query.Node) LeafLockBuilder

	// Where adds a condition to filter what gets selected.
	// Calling Where multiple times will AND the conditions together.
	Where(c query.Node) LeafLockBuilder

	// OrderBy specifies how the resulting data should be sorted.
	// By default, the given nodes are sorted in ascending order.
	// Add Descending() to the node to specify that it should be sorted in descending order.
	OrderBy(nodes ...query.Sorter) LeafLockBuilder

	// Limit will return a subset of the data, limited to the offset and number of rows specified.
	// For large data sets and specific types of queries, this can be slow, because it will perform
	// the entire query before computing the limit.
	// You cannot limit a query that has selected a "many" relationship".
	Limit(maxRowCount int, offset int) LeafLockBuilder
	...
	Calculation(base query.TableNodeI, alias string, operation query.OperationNodeI) LeafLockBuilder

	// Distinct removes duplicates from the results of the query.
	// Adding a Select() is required.
	Distinct() LeafLockBuilder

	// GroupBy controls how results are grouped when using aggregate functions with Calculation.
	GroupBy(nodes ...query.Node) LeafLockBuilder
...
func newLeafLockBuilder(ctx context.Context) LeafLockBuilder {
	b := leafLockQueryBuilder{
		builder: query.NewBuilder(ctx, node.LeafLock()),
	}
	return &b
}
...
// Where adds a condition to filter what gets selected.
// Calling Where multiple times will AND the conditions together.
func (b *leafLockQueryBuilder) Where(c query.Node) LeafLockBuilder {
	b.builder.Where(c)
	return b
}
...
// By default, the given nodes are sorted in ascending order.
// Add Descending() to the node to specify that it should be sorted in descending order.
func (b *leafLockQueryBuilder) OrderBy(nodes ...query.Sorter) LeafLockBuilder {
...
func (b *leafLockQueryBuilder) Limit(maxRowCount int, offset int) LeafLockBuilder {
	b.builder.Limit(maxRowCount, offset)
	return b
}

// Select specifies what specific columns will be loaded with data.
// By default, all the columns of the leaf_lock table will be queried and loaded.
// If nodes contains columns from the leaf_lock table, that will limit the columns queried and loaded to only those columns.
...
func (b *leafLockQueryBuilder) Select(nodes ...query.Node) LeafLockBuilder {
...
func (b *leafLockQueryBuilder) Calculation(base query.TableNodeI, alias string, operation query.OperationNodeI) LeafLockBuilder {
...
func (b *leafLockQueryBuilder) Distinct() LeafLockBuilder {
	b.builder.Distinct()
	return b
}

// GroupBy controls how results are grouped when using aggregate functions with Calculation.
func (b *leafLockQueryBuilder) GroupBy(nodes ...query.Node) LeafLockBuilder {
	b.builder.GroupBy(nodes...)
	return b
}

// Having does additional filtering on the results of the query after the query is performed.
func (b *leafLockQueryBuilder) Having(node query.Node) LeafLockBuilder {
...
func (o *leafLockBase) load(m map[string]interface{}, objThis *LeafLock) {
...
func (o *leafLockBase) save(ctx context.Context) error {
	if o._restored {
		return o.update(ctx)
	} else {
		return o.insert(ctx)
...
func (o *leafLockBase) update(ctx context.Context) error {
	if !o._restored {
	...
	o.resetDirtyStatus()
	if len(modifiedFields) != 0 {
		broadcast.Update(ctx, "goradd_unit", "leaf_lock", o._originalPK, all.SortedKeys(modifiedFields)...)
	}
...
func (o *leafLockBase) insert(ctx context.Context) (err error) {
	...
	o.resetDirtyStatus()
	o._restored = true
	broadcast.Insert(ctx, "goradd_unit", "leaf_lock", o.PrimaryKey())
	return
}
...
func (o *leafLockBase) getUpdateFields() (fields map[string]interface{}) {
...
func (o *leafLockBase) getInsertFields() (fields map[string]interface{}) {
	fields = map[string]interface{}{}
	if o.idIsDirty {
		fields["id"] = o.id
	}
...
func (o *leafLockBase) Delete(ctx context.Context) (err error) {
	if o == nil {
...
// deleteLeafLock deletes the LeafLock with primary key pk from the database
...
func (o *leafLockBase) Get(key string) interface{} {
...
func (o *leafLockBase) MarshalBinary() ([]byte, error) {
	...
	if err := encoder.Encode(o.id); err != nil {
		return nil, fmt.Errorf("error encoding LeafLock.id: %w", err)
	}
	if err := encoder.Encode(o.idIsLoaded); err != nil {
		return nil, fmt.Errorf("error encoding LeafLock.idIsLoaded: %w", err)
	}
	if err := encoder.Encode(o.idIsDirty); err != nil {
		return nil, fmt.Errorf("error encoding LeafLock.idIsDirty: %w", err)
	}

	if err := encoder.Encode(o.name); err != nil {
		return nil, fmt.Errorf("error encoding LeafLock.name: %w", err)
	}
	if err := encoder.Encode(o.nameIsLoaded); err != nil {
		return nil, fmt.Errorf("error encoding LeafLock.nameIsLoaded: %w", err)
	}
	...
	if err := encoder.Encode(o.groLockIsLoaded); err != nil {
		return nil, fmt.Errorf("error encoding LeafLock.groLockIsLoaded: %w", err)
	}
	...
	if o._aliases == nil {
		...
		if err := encoder.Encode(o._aliases); err != nil {
			return nil, fmt.Errorf("error encoding LeafLock._aliases: %w", err)
		}
	}

	if err := encoder.Encode(o._restored); err != nil {
		return nil, fmt.Errorf("error encoding LeafLock._restored: %w", err)
	}
	if err := encoder.Encode(o._originalPK); err != nil {
		return nil, fmt.Errorf("error encoding LeafLock._originalPK: %w", err)
	}
...
func (o *leafLockBase) UnmarshalBinary(data []byte) (err error) {
	...
	if err = dec.Decode(&o.id); err != nil {
		return fmt.Errorf("error decoding LeafLock.id: %w", err)
	}
	if err = dec.Decode(&o.idIsLoaded); err != nil {
		return fmt.Errorf("error decoding LeafLock.idIsLoaded: %w", err)
	}
	if err = dec.Decode(&o.idIsDirty); err != nil {
		return fmt.Errorf("error decoding LeafLock.idIsDirty: %w", err)
	}

	if err = dec.Decode(&o.name); err != nil {
		return fmt.Errorf("error decoding LeafLock.name: %w", err)
	}
	if err = dec.Decode(&o.nameIsLoaded); err != nil {
		return fmt.Errorf("error decoding LeafLock.nameIsLoaded: %w", err)
	}
...
func (o *leafLockBase) MarshalJSON() (data []byte, err error) {
...
func (o *leafLockBase) MarshalStringMap() map[string]interface{} {
...
// UnmarshalJSON unmarshalls the given json data into the LeafLock. The LeafLock can be a
...
//
// Override this in LeafLock to modify the json before sending it here.
func (o *leafLockBase) UnmarshalStringMap(m map[string]interface{}) (err error) {
	for k, v := range m {
		switch k {
