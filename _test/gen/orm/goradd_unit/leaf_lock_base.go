...
// Copy copies all valid fields to a new LeafLock object.
...
func (o *leafLockBase) IDIsValid() bool {
...
func (o *leafLockBase) NameIsValid() bool {
...
func (o *leafLockBase) GetAlias(key string) query.AliasValue {
...
// If there are any errors, nil is returned and the specific error is stored in the context.
// If no results come back from the query, it will return a non-nil empty slice.
func (b *leafLockQueryBuilder) LoadI() (leafLocks []any) {
	b.builder.Command = query.BuilderCommandLoad
	database := db.GetDatabase("goradd_unit")
	results := database.BuilderQuery(b.builder)
	if results == nil {
...
func (o *leafLockBase) getModifiedFields() (fields map[string]interface{}) {
...
func (o *leafLockBase) getValidFields() (fields map[string]interface{}) {
	fields = map[string]interface{}{}
	if o.nameIsValid {
		fields["name"] = o.name
	}
...
func (o *leafLockBase) MarshalBinary() ([]byte, error) {
	...
	if err := encoder.Encode(o.idIsValid); err != nil {
		return nil, fmt.Errorf("error encoding LeafLock.idIsValid: %w", err)
	}
	...
	if err := encoder.Encode(o.nameIsValid); err != nil {
		return nil, fmt.Errorf("error encoding LeafLock.nameIsValid: %w", err)
	}
...
func (o *leafLockBase) UnmarshalBinary(data []byte) (err error) {
	...
	if err = dec.Decode(&o.idIsValid); err != nil {
		return fmt.Errorf("error decoding LeafLock.idIsValid: %w", err)
	}
	...
	if err = dec.Decode(&o.nameIsValid); err != nil {
		return fmt.Errorf("error decoding LeafLock.nameIsValid: %w", err)
	}
