...
func (o *forwardNullUniqueBase) Save(ctx context.Context) {
	if o._restored {
		o.update(ctx)
	} else {
		o.insert(ctx)
...
func (o *forwardNullUniqueBase) update(ctx context.Context) {
	if !o._restored {
...
func (o *forwardNullUniqueBase) insert(ctx context.Context) {
	d := Database()
	db.ExecuteTransaction(ctx, d, func() {
...
func (o *forwardNullUniqueBase) Delete(ctx context.Context) {
	if !o._restored {
