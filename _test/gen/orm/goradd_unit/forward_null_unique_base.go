...
// ForwardNullUniqueBase is embedded in a ForwardNullUnique object and provides the ORM access to the database.
// The member variables of the structure are private and should not normally be accessed by the ForwardNullUnique embedder.
// Instead, use the accessor functions.
type forwardNullUniqueBase struct {
	id        string
	idIsValid bool
...
// IDs used to access the ForwardNullUnique object fields by name using the Get function.
// doc: type=ForwardNullUnique
const (
	ForwardNullUnique_ID        = `ID`
	ForwardNullUnique_Name      = `Name`
	ForwardNullUnique_ReverseID = `ReverseID`
	ForwardNullUnique_Reverse   = `Reverse`
)

const ForwardNullUniqueNameMaxLength = 100 // The number of runes the column can hold

// Initialize or re-initialize a ForwardNullUnique database object to default values.
// The primary key will get a temporary negative number which will be replaced when the object is saved.
// Multiple calls to Initialize are not guaranteed to create sequential values for the primary key.
func (o *forwardNullUniqueBase) Initialize() {
...
func (o *forwardNullUniqueBase) PrimaryKey() string {
	return o.id
}

// OriginalPrimaryKey returns the value of the primary key that was originally loaded into the object when it was
// read from the database.
func (o *forwardNullUniqueBase) OriginalPrimaryKey() string {
	return o._originalPK
}

// Copy copies all valid fields to a new ForwardNullUnique object.
// Forward reference ids will be copied, but reverse and many-many references will not.
// Attached objects will not be included in the copy.
// Call Save() on the new object to save it into the database.
// Copy might panic if any fields in the database were set to a size larger than the
// maximum size through a process that accessed the database outside of the ORM.
func (o *forwardNullUniqueBase) Copy() (newObject *ForwardNullUnique) {
	newObject = NewForwardNullUnique()
	if o.nameIsValid {
...
// if it is loaded.
func (o *forwardNullUniqueBase) ID() string {
	return fmt.Sprint(o.id)
}

// IDIsValid returns true if the value was loaded from the database or has been set.
func (o *forwardNullUniqueBase) IDIsValid() bool {
	return o._restored && o.idIsValid
}

// Name returns the loaded value of Name.
func (o *forwardNullUniqueBase) Name() string {
...
func (o *forwardNullUniqueBase) NameIsValid() bool {
...
func (o *forwardNullUniqueBase) SetName(v string) {
	if utf8.RuneCountInString(v) > ForwardNullUniqueNameMaxLength {
...
func (o *forwardNullUniqueBase) ReverseID() string {
...
func (o *forwardNullUniqueBase) ReverseIDIsValid() bool {
	return o.reverseIDIsValid
}

// ReverseIDIsNull returns true if the related database value is null.
func (o *forwardNullUniqueBase) ReverseIDIsNull() bool {
...
func (o *forwardNullUniqueBase) ReverseID_I() interface{} {
	if o._restored && !o.reverseIDIsValid {
		panic("reverseID was not selected in the last query and has not been set, and so is not valid")
...
func (o *forwardNullUniqueBase) SetReverseID(v string) {
	if o._restored &&
...
func (o *forwardNullUniqueBase) SetReverseIDToNull() {
...
func (o *forwardNullUniqueBase) Reverse() *Reverse {
	return o.objReverse
}
...
func (o *forwardNullUniqueBase) LoadReverse(ctx context.Context) *Reverse {
	if !o.reverseIDIsValid {
		return nil
	}
...
// will be saved when ForwardNullUnique is saved. Pass nil to break the connection.
func (o *forwardNullUniqueBase) SetReverse(objReverse *Reverse) {
	o.reverseIDIsValid = true
	if objReverse == nil {
...
func (o *forwardNullUniqueBase) GetAlias(key string) query.AliasValue {
...
func (o *forwardNullUniqueBase) IsNew() bool {
	return !o._restored
}

// LoadForwardNullUnique returns a ForwardNullUnique from the database.
// selectNodes lets you provide nodes for selecting specific fields or additional fields from related tables.
// See [ForwardNullUniquesBuilder.Select] for more info.
func LoadForwardNullUnique(ctx context.Context, id string, selectNodes ...query.Node) *ForwardNullUnique {
...
// HasForwardNullUnique returns true if a ForwardNullUnique with the given primaryKey exists in the database.
// doc: type=ForwardNullUnique
...
// See [ForwardNullUniquesBuilder.Select].
// If you need a more elaborate query, use QueryForwardNullUniques() to start a query builder.
func LoadForwardNullUniqueByReverseID(ctx context.Context, reverseID interface{}, selectNodes ...query.Node) *ForwardNullUnique {
...
// HasForwardNullUniqueByReverseID returns true if the
// given unique index values exist in the database.
// doc: type=ForwardNullUnique
func HasForwardNullUniqueByReverseID(ctx context.Context, reverseID interface{}) bool {
	q := queryForwardNullUniques(ctx)
	if reverseID == nil {
		q = q.Where(op.IsNull(node.ForwardNullUnique().ReverseID()))
	} else {
...
type ForwardNullUniqueBuilder interface {
	...
	OrderBy(nodes ...query.Sorter) ForwardNullUniqueBuilder

	// Limit will return a subset of the data, limited to the offset and number of rows specified.
	// For large data sets and specific types of queries, this can be slow, because it will perform
	// the entire query before computing the limit.
	// You cannot limit a query that has embedded arrays.
	Limit(maxRowCount int, offset int) ForwardNullUniqueBuilder
	...
	Select(nodes ...query.Node) ForwardNullUniqueBuilder
	...
	GroupBy(nodes ...query.Node) ForwardNullUniqueBuilder

	// Having does additional filtering on the results of the query after the query is performed.
	Having(node query.Node) ForwardNullUniqueBuilder
	...
	LoadCursor() forwardNullUniquesCursor
...
type forwardNullUniqueQueryBuilder struct {
...
func (b *forwardNullUniqueQueryBuilder) Load() (forwardNullUniques []*ForwardNullUnique) {
	...
	for _, item := range results.([]map[string]any) {
		...
		o.load(item, o)
		forwardNullUniques = append(forwardNullUniques, o)
	}
	return
}
...
func (b *forwardNullUniqueQueryBuilder) LoadCursor() forwardNullUniquesCursor {
	...
	return forwardNullUniquesCursor{cursor}
}

type forwardNullUniquesCursor struct {
	query.CursorI
}

// Next returns the current ForwardNullUnique object and moves the cursor to the next one.
//
// If there are no more records, it returns nil.
func (c forwardNullUniquesCursor) Next() *ForwardNullUnique {
	if c.CursorI == nil {
		return nil
	}
...
// If an error occurs, or no results are found, a nil is returned.
// In the case of an error, the error is returned in the context.
func (b *forwardNullUniqueQueryBuilder) Get() *ForwardNullUnique {
	results := b.Load()
...
func (b *forwardNullUniqueQueryBuilder) Join(alias string, joinedTable query.Node, condition query.Node) ForwardNullUniqueBuilder {
    if query.RootNode(n).TableName_() != "forward_null_unique" {
...
// Where adds a condition to filter what gets selected.
// Calling Where multiple times will AND the conditions together.
func (b *forwardNullUniqueQueryBuilder) Where(c query.Node) ForwardNullUniqueBuilder {
	b.builder.Where(c)
	return b
}
...
// By default, the given nodes are sorted in ascending order.
// Add Descending() to the node to specify that it should be sorted in descending order.
func (b *forwardNullUniqueQueryBuilder) OrderBy(nodes ...query.Sorter) ForwardNullUniqueBuilder {
...
// the entire query before computing the limit.
// You cannot limit a query that has embedded arrays.
func (b *forwardNullUniqueQueryBuilder) Limit(maxRowCount int, offset int) ForwardNullUniqueBuilder {
	b.builder.Limit(maxRowCount, offset)
	return b
}

// Select specifies what specific columns will be loaded with data.
// By default, all the columns of the forward_null_unique table will be queried and loaded.
// If nodes contains columns from the forward_null_unique table, that will limit the columns queried and loaded to only those columns.
...
func (b *forwardNullUniqueQueryBuilder) Select(nodes ...query.Node) ForwardNullUniqueBuilder {
...
func (b *forwardNullUniqueQueryBuilder) Distinct() ForwardNullUniqueBuilder {
	b.builder.Distinct()
	return b
}

// GroupBy controls how results are grouped when using aggregate functions with Calculation.
func (b *forwardNullUniqueQueryBuilder) GroupBy(nodes ...query.Node) ForwardNullUniqueBuilder {
	b.builder.GroupBy(nodes...)
	return b
}

// Having does additional filtering on the results of the query after the query is performed.
func (b *forwardNullUniqueQueryBuilder) Having(node query.Node) ForwardNullUniqueBuilder {
...
// You MUST include what you are selecting by adding Calculation or Select functions on the subquery builder.
// Generally you would use this as a node to a Calculation function on the surrounding query builder.
func (b *forwardNullUniqueQueryBuilder)  Subquery() *query.SubqueryNode {
	 return b.builder.Subquery()
}
*/

// CountForwardNullUniqueByID queries the database and returns the number of ForwardNullUnique objects that
// have id.
// doc: type=ForwardNullUnique
...
// have reverseID.
// doc: type=ForwardNullUnique
func CountForwardNullUniqueByReverseID(ctx context.Context, reverseID string) int {
	if reverseID == "" {
		return 0
	}
...
func (o *forwardNullUniqueBase) load(m map[string]interface{}, objThis *ForwardNullUnique) {
...
func (o *forwardNullUniqueBase) Save(ctx context.Context) error {
	if o._restored {
		return o.update(ctx)
	} else {
		return o.insert(ctx)
...
func (o *forwardNullUniqueBase) update(ctx context.Context) (err error) {
	if !o._restored {
	...
	err = db.ExecuteTransaction(ctx, d, func() error {
		...
		if len(modifiedFields) != 0 {
			d.Update(ctx, "forward_null_unique", modifiedFields, map[string]any{"id": o._originalPK})
		}
	...
	o.resetDirtyStatus()
	if len(modifiedFields) != 0 {
		broadcast.Update(ctx, "goradd_unit", "forward_null_unique", o._originalPK, all.SortedKeys(modifiedFields)...)
	}
...
func (o *forwardNullUniqueBase) insert(ctx context.Context) (err error) {
	d := Database()
	err = db.ExecuteTransaction(ctx, d, func() error {
		...
		id := d.Insert(ctx, "forward_null_unique", m)
		o.id = id
		o._originalPK = id
	...
	o.resetDirtyStatus()
	o._restored = true
	broadcast.Insert(ctx, "goradd_unit", "forward_null_unique", o.PrimaryKey())
	return
}

// getModifiedFields returns the database columns that have been modified. This
// will determine which specific fields are sent to the database to be changed.
func (o *forwardNullUniqueBase) getModifiedFields() (fields map[string]interface{}) {
...
func (o *forwardNullUniqueBase) getValidFields() (fields map[string]interface{}) {
	fields = map[string]interface{}{}
	if o.nameIsValid {
		fields["name"] = o.name
	}
...
func (o *forwardNullUniqueBase) Delete(ctx context.Context) (err error) {
	if !o._restored {
		panic("Cannot delete a record that has no primary key value.")
	}
	d := Database()
	d.Delete(ctx, "forward_null_unique", map[string]any{"ID": o.id})
	return nil
	broadcast.Delete(ctx, "goradd_unit", "forward_null_unique", fmt.Sprint(o.id))
	return
}

// deleteForwardNullUnique deletes the ForwardNullUnique with primary key pk from the database
// and handles associated records.
func deleteForwardNullUnique(ctx context.Context, pk string) error {
	d := db.GetDatabase("goradd_unit")
	d.Delete(ctx, "forward_null_unique", map[string]any{"ID": pk})
	broadcast.Delete(ctx, "goradd_unit", "forward_null_unique", fmt.Sprint(pk))
	return nil
}

// resetDirtyStatus resets the dirty status of every field in the object.
func (o *forwardNullUniqueBase) resetDirtyStatus() {
	o.nameIsDirty = false
	o.reverseIDIsDirty = false
...
func (o *forwardNullUniqueBase) IsDirty() (dirty bool) {
	dirty = o.nameIsDirty ||
		o.reverseIDIsDirty ||
...
func (o *forwardNullUniqueBase) Get(key string) interface{} {
...
func (o *forwardNullUniqueBase) MarshalBinary() ([]byte, error) {
...
// UnmarshalBinary converts a structure that was created with MarshalBinary into a ForwardNullUnique object.
func (o *forwardNullUniqueBase) UnmarshalBinary(data []byte) (err error) {
...
func (o *forwardNullUniqueBase) MarshalJSON() (data []byte, err error) {
...
func (o *forwardNullUniqueBase) MarshalStringMap() map[string]interface{} {
...
// UnmarshalJSON unmarshalls the given json data into the ForwardNullUnique. The ForwardNullUnique can be a
...
func (o *forwardNullUniqueBase) UnmarshalJSON(data []byte) (err error) {
...
//
// Override this in ForwardNullUnique to modify the json before sending it here.
func (o *forwardNullUniqueBase) UnmarshalStringMap(m map[string]interface{}) (err error) {
	for k, v := range m {
		switch k {
