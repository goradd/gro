...
// Copy copies all valid fields (except for the primary key) to a new ForwardNullUnique object.
...
func (b *ForwardNullUniquesBuilder) Expand(n query.NodeI) *ForwardNullUniquesBuilder {
	b.builder.Expand(n)
	return b
}
