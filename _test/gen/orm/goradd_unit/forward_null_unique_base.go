...
// The ForwardNullUniquesBuilder uses the QueryBuilderI interface from the database to build a query.
// All query operations go through this query builder.
// End a query by calling either Load, Count, or Delete
type ForwardNullUniquesBuilder struct {
	builder query.QueryBuilderI
}

func newForwardNullUniqueBuilder(ctx context.Context) *ForwardNullUniquesBuilder {
	b := &ForwardNullUniquesBuilder{
		builder: db.GetDatabase("goradd_unit").NewBuilder(ctx),
	}
	return b.Join(node.ForwardNullUnique())
}

// Load terminates the query builder, performs the query, and returns a slice of ForwardNullUnique objects. If there are
// any errors, they are returned in the context object. If no results come back from the query, it will return
// an empty slice
func (b *ForwardNullUniquesBuilder) Load() (forwardNullUniques []*ForwardNullUnique) {
...
// any errors, they are returned in the context object. If no results come back from the query, it will return
// an empty slice.
func (b *ForwardNullUniquesBuilder) LoadI() (forwardNullUniques []interface{}) {
	results := b.builder.Load()
	if results == nil {
		return
	}
...
func (b *ForwardNullUniquesBuilder) LoadCursor() forwardNullUniquesCursor {
...
func (b *ForwardNullUniquesBuilder) Get() *ForwardNullUnique {
	results := b.Load()
...
func (b *ForwardNullUniquesBuilder) Expand(node query.Expander) *ForwardNullUniquesBuilder {
	n := node.(query.NodeI)
	if query.NodeTableName(query.RootNode(n)) != "forward_null_unique" {
		panic("you can only expand a node that is rooted at node.ForwardNullUnique()")
	}
...
func (b *ForwardNullUniquesBuilder) Limit(maxRowCount int, offset int) *ForwardNullUniquesBuilder {
...
func (b *ForwardNullUniquesBuilder) Distinct() *ForwardNullUniquesBuilder {
	b.builder.Distinct()
	return b
}
...
func (b *ForwardNullUniquesBuilder) Delete() {
	b.builder.Delete()
...
func (b *ForwardNullUniquesBuilder) Subquery() *query.SubqueryNode {
