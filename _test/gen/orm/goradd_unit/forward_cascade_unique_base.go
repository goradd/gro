...
// Copy copies all valid fields (except for the primary key) to a new ForwardCascadeUnique object.
...
func (b *ForwardCascadeUniquesBuilder) Expand(n query.NodeI) *ForwardCascadeUniquesBuilder {
	b.builder.Expand(n)
	return b
}
