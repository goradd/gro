...
// Copy copies all valid fields (except for the primary key) to a new DoubleIndex object.
...
func (b *DoubleIndicesBuilder) Expand(n query.NodeI) *DoubleIndicesBuilder {
	b.builder.Expand(n)
	return b
}
