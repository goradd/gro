...
func (o *employeeInfoBase) update(ctx context.Context) error {
	...
	err := db.WithTransaction(ctx, d, func(ctx context.Context) error {
		...
		if len(modifiedFields) != 0 {
			err2 := d.Update(ctx, "employee_info",
				map[string]any{
					"id": o._originalPK,
				},
				modifiedFields,
...
func (o *employeeInfoBase) insert(ctx context.Context) (err error) {
	...
	err = db.WithTransaction(ctx, d, func(ctx context.Context) error {
		...
		err = d.Insert(ctx, "employee_info", insertFields, "")
		if err != nil {
			return err
		}
...
func (o *employeeInfoBase) Get(key string) interface{} {
	switch key {
	case EmployeeInfoIDField:
		if !o.idIsLoaded {
			return nil
		}
		return o.id
	case EmployeeInfoEmployeeNumberField:
		if !o.employeeNumberIsLoaded {
			return nil
		}
		return o.employeeNumber
	case EmployeeInfoPersonIDField:
		if !o.personIDIsLoaded {
			return nil
		}
		return o.personID
	case EmployeeInfoPersonField:
		return o.Person()
	}
	return nil
}
