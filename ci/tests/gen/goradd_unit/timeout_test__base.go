...
func (o *timeoutTestBase) update(ctx context.Context) error {
	...
	err := db.WithTransaction(ctx, d, func(ctx context.Context) error {
		...
		if len(modifiedFields) != 0 {
			err2 := d.Update(ctx, "timeout_test",
				map[string]any{
					"id": o._originalPK,
				},
				modifiedFields,
...
func (o *timeoutTestBase) Delete(ctx context.Context) (err error) {
	...
	broadcast.Delete(ctx, "goradd_unit", "timeout_test", o._originalPK)
	return
}
...
func deleteTimeoutTest(ctx context.Context, pk query.AutoPrimaryKey) error {
	...
	broadcast.Delete(ctx, "goradd_unit", "timeout_test", pk)
	return err
}
...
func (o *timeoutTestBase) Get(key string) interface{} {
	switch key {
	case TimeoutTestIDField:
		if !o.idIsLoaded {
			return nil
		}
		return o.id
	case TimeoutTestNameField:
		if !o.nameIsLoaded {
			return nil
		}
		return o.name
