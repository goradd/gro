...
type rootUnlBase struct {
	...
	// Reverse references
	leafUnl        *LeafUnl
	leafUnlIsDirty bool // is a new one being associated
...
func (o *rootUnlBase) OriginalPrimaryKey() query.AutoPrimaryKey {
	return o._originalPK
}

// PrimaryKey returns the value of the primary key of the record.
func (o *rootUnlBase) PrimaryKey() query.AutoPrimaryKey {
...
func (o *rootUnlBase) SetPrimaryKey(v query.AutoPrimaryKey) {
	o.SetID(v)
}

// ID returns the loaded value of the id field in the database.
func (o *rootUnlBase) ID() query.AutoPrimaryKey {
	if o._restored && !o.idIsLoaded {
...
// You cannot change a primary key for a record that has been written to the database. While SQL databases will
// allow it, NoSql databases will not. Save a copy and delete this one instead.
func (o *rootUnlBase) SetID(v query.AutoPrimaryKey) {
	if o._restored {
...
func (o *rootUnlBase) LoadLeafUnl(ctx context.Context) (*LeafUnl, error) {
	if o.leafUnl != nil && o.leafUnl.IsDirty() {
		panic("The LeafUnl has changed. You must save it first before changing to a different one.")
	}
	var err error
	if o.leafUnl == nil {
		pk := o.ID()
		o.leafUnl, err = LoadLeafUnlByRootUnlID(ctx, pk)
	}
	return o.leafUnl, err
}

// SetLeafUnl associates obj with this RootUnl
// through the reverse relationship in LeafUnl.RootUnl.
//
...
// that LeafUnl's RootUnl value will be set to null when Save is called.
...
func LoadRootUnl(ctx context.Context, pk query.AutoPrimaryKey, selectNodes ...query.Node) (*RootUnl, error) {
	return queryRootUnls(ctx).
		Where(op.Equal(node.RootUnl().ID(), pk)).
		Select(selectNodes...).
		Get()
}
...
func (o *rootUnlBase) unpack(m map[string]interface{}, objThis *RootUnl) {
	...
	if v, ok := m["leafUnl"]; ok {
		if v2, ok2 := v.(map[string]any); ok2 {
			o.leafUnl = new(LeafUnl)
			o.leafUnl.unpack(v2, o.leafUnl)
			o.leafUnlIsDirty = false
		} else {
			panic("Wrong type found for leafUnl object.")
		}
	} else {
		o.leafUnl = nil
		o.leafUnlIsDirty = false
	...
	err := db.WithTransaction(ctx, d, func(ctx context.Context) error {
		...
		if o.leafUnlIsDirty {
			...
			if obj, err := QueryLeafUnls(ctx).
				...
				(o.leafUnl == nil ||
					obj.PrimaryKey() != o.leafUnl.PrimaryKey()) {
			...
			if o.leafUnl != nil {
				o.leafUnl.rootUnlIDIsDirty = true // force a change in case data is stale
				o.leafUnl.SetRootUnlID(o.PrimaryKey())
				if err := o.leafUnl.Save(ctx); err != nil {
					return err
				}
			}
...
func (o *rootUnlBase) insert(ctx context.Context) (err error) {
	...
	err = db.WithTransaction(ctx, d, func(ctx context.Context) error {
		...
		err = d.Insert(ctx, "root_unl", insertFields, "id")
		if err != nil {
			return err
		}
...
func (o *rootUnlBase) Delete(ctx context.Context) (err error) {
	...
	broadcast.Delete(ctx, "goradd_unit", "root_unl", o._originalPK)
	return
}
...
func (o *rootUnlBase) IsDirty() (dirty bool) {
	...
	dirty = dirty || (o.leafUnl != nil && o.leafUnl.IsDirty())
...
func (o *rootUnlBase) Get(key string) interface{} {
	...
	case RootUnlIDField:
		...
		return o.id
	case RootUnlNameField:
		if !o.nameIsLoaded {
			return nil
		}
		return o.name
	case RootUnlGroLockField:
		if !o.groLockIsLoaded {
			return nil
		}
		return o.groLock
	case RootUnlLeafUnlField:
		return o.leafUnl
	}
	return nil
}
...
func (o *rootUnlBase) encodeTo(enc db.Encoder) error {
	...
	if o.leafUnl == nil {
		...
		if err := enc.Encode(o.leafUnl); err != nil {
			return fmt.Errorf("error encoding RootUnl.leafUnl: %w", err)
		}
	}

	if err := enc.Encode(o.leafUnlIsDirty); err != nil {
		return fmt.Errorf("error encoding RootUnl.leafUnlIsDirty: %w", err)
	}
...
func (o *rootUnlBase) decodeFrom(dec db.Decoder) (err error) {
	...
	if err = dec.Decode(&isPtr); err != nil {
		return fmt.Errorf("error decoding RootUnl.leafUnl isPtr: %w", err)
	}
	if isPtr {
		if err = dec.Decode(&o.leafUnl); err != nil {
			return fmt.Errorf("error decoding RootUnl.leafUnl: %w", err)
		}
	}

	if err = dec.Decode(&o.leafUnlIsDirty); err != nil {
		return fmt.Errorf("error decoding RootUnl.leafUnlIsDirty: %w", err)
	}
	if err = dec.Decode(&isPtr); err != nil {
