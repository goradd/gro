...
func (o *TwoKey) String() string {
	...
	pk += fmt.Sprintf(" %v", o.Server())

	pk += fmt.Sprintf(" %v", o.Directory())
...
func (o *TwoKey) Label() string {
	...
	return fmt.Sprintf("Two Key %v", o.PrimaryKey())
}
...
// See TwoKeyBuilder for doc on how to use the builder.
...
// getTwoKeyInsertFields returns fields and values that will be used for a new record in the database.
...
func getTwoKeyInsertFields(o *twoKeyBase) (fields map[string]interface{}) {
	return o.getInsertFields()
}

// getTwoKeyUpdateFields returns fields and values that will be used to update a current record in
// the database.
// You can add or modify the fields here before they are sent to the database.
func getTwoKeyUpdateFields(o *twoKeyBase) (fields map[string]interface{}) {
