...
// Will also set the attached o.Parent1 to nil.
...
// Will also set the attached o.Parent2 to nil.
...
// HasMultiParentByParent1ID returns true if the
...
// HasMultiParentByParent2ID returns true if the
// given index values exist in the database.
// doc: type=MultiParent
...
func (o *multiParentBase) update(ctx context.Context) error {
	...
	err := db.WithTransaction(ctx, d, func(ctx context.Context) error {
		...
		if len(modifiedFields) != 0 {
			err2 := d.Update(ctx, "multi_parent",
				map[string]any{
					"id": o._originalPK,
				},
				modifiedFields,
...
//
// Associated Parent1MultiParent will have their Parent1 field set to NULL.
// Associated Parent2MultiParent will have their Parent2 field set to NULL.
func (o *multiParentBase) Delete(ctx context.Context) (err error) {
	...
	err = db.WithTransaction(ctx, d, func(ctx context.Context) error {
		...
		return d.Delete(ctx, "multi_parent",
	...
	broadcast.Delete(ctx, "goradd_unit", "multi_parent", o._originalPK)
	return
}
...
func (o *multiParentBase) Get(key string) interface{} {
	switch key {
	case MultiParentIDField:
		if !o.idIsLoaded {
			return nil
		}
		return o.id
	case MultiParentNameField:
		if !o.nameIsLoaded {
			return nil
		}
		return o.name
	case MultiParentParent1IDField:
		if !o.parent1IDIsLoaded {
			return nil
		}
		return o.parent1ID
	case MultiParentParent2IDField:
		if !o.parent2IDIsLoaded {
			return nil
		}
		return o.parent2ID
	case MultiParentParent1Field:
		return o.Parent1()
	case MultiParentParent2Field:
		return o.Parent2()
	case MultiParentParent1MultiParentField:
		return o.parent1MultiParents.Values()
	case MultiParentParent2MultiParentField:
		return o.parent2MultiParents.Values()
	}
	return nil
}
...
func (o *multiParentBase) encodeTo(enc db.Encoder) error {
	...
	if err := enc.Encode(o.parent1IDIsNull); err != nil {
	...
	if err := enc.Encode(o.parent2IDIsNull); err != nil {
