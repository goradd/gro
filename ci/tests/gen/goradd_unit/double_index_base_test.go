...
func TestDoubleIndex_Getters(t *testing.T) {
	...
	assert.Equal(t, obj.ID(), obj.Get(DoubleIndexIDField))
	assert.Equal(t, obj.FieldInt(), obj.Get(DoubleIndexFieldIntField))
	assert.Panics(t, func() { obj2.FieldInt() })
	assert.Nil(t, obj2.Get(DoubleIndexFieldIntField))
	assert.Equal(t, obj.FieldString(), obj.Get(DoubleIndexFieldStringField))
	assert.Panics(t, func() { obj2.FieldString() })
	assert.Nil(t, obj2.Get(DoubleIndexFieldStringField))
	assert.Equal(t, obj.Field2Int(), obj.Get(DoubleIndexField2IntField))
	assert.Panics(t, func() { obj2.Field2Int() })
	assert.Nil(t, obj2.Get(DoubleIndexField2IntField))
	assert.Equal(t, obj.Field2String(), obj.Get(DoubleIndexField2StringField))
	assert.Panics(t, func() { obj2.Field2String() })
	assert.Nil(t, obj2.Get(DoubleIndexField2StringField))
...
func TestDoubleIndex_QueryLoadI(t *testing.T) {
	...
	assert.Equal(t, obj.PrimaryKey(), objs[0].(*DoubleIndex).PrimaryKey())
}
