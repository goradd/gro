...
// Will also set the attached o.AltRootUn to nil.
...
func (o *altLeafUnBase) unpack(m map[string]interface{}, objThis *AltLeafUn) {
	...
	if v, ok := m["altRootUnID"]; ok {
		if v == nil {
			...
			panic("Wrong type found for altRootUnID.")
		}
	} else {
		o.altRootUnIDIsLoaded = false
		o.altRootUnIDIsNull = true
...
func (o *altLeafUnBase) Delete(ctx context.Context) (err error) {
	...
	broadcast.Delete(ctx, "goradd_unit", "alt_leaf_un", o._originalPK)
	return
}
...
func deleteAltLeafUn(ctx context.Context, pk query.AutoPrimaryKey) error {
	...
	broadcast.Delete(ctx, "goradd_unit", "alt_leaf_un", pk)
	return err
}
...
func (o *altLeafUnBase) Get(key string) interface{} {
	switch key {
	case AltLeafUnIDField:
		if !o.idIsLoaded {
			return nil
		}
		return o.id
	case AltLeafUnNameField:
		if !o.nameIsLoaded {
			return nil
		}
		return o.name
	case AltLeafUnAltRootUnIDField:
		if !o.altRootUnIDIsLoaded {
			return nil
		}
		return o.altRootUnID
	case AltLeafUnAltRootUnField:
		return o.AltRootUn()
	}
	return nil
}
