...
// Will also set the attached o.RootUnl to nil.
...
func (o *leafUnlBase) Delete(ctx context.Context) (err error) {
	...
	broadcast.Delete(ctx, "goradd_unit", "leaf_unl", o._originalPK)
	return
}
...
func deleteLeafUnl(ctx context.Context, pk query.AutoPrimaryKey) error {
	...
	broadcast.Delete(ctx, "goradd_unit", "leaf_unl", pk)
	return err
}
...
func (o *leafUnlBase) Get(key string) interface{} {
	...
	case LeafUnlIDField:
		...
		return o.id
	case LeafUnlNameField:
		if !o.nameIsLoaded {
			return nil
		}
		return o.name
	case LeafUnlGroLockField:
		if !o.groLockIsLoaded {
			return nil
		}
		return o.groLock
	case LeafUnlRootUnlIDField:
		if !o.rootUnlIDIsLoaded {
			return nil
		}
		return o.rootUnlID
	case LeafUnlRootUnlField:
		return o.RootUnl()
	}
	return nil
}
		...
		case "rootUnlID":
			{
				...
				if u, ok := Database().(db.AutoPrimaryKeyJsonUnmarshaller); ok {
					...
					case json.Number:
						...
						o.SetRootUnlID(query.NewAutoPrimaryKey(n2))
					default:
						o.SetRootUnlID(query.NewAutoPrimaryKey(v))
					}
				}
			}
