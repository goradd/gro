...
func (o *twoKeyBase) SetPrimaryKey(v TwoKeyPrimaryKey) {
	o.SetServer(v.Server)
	o.SetDirectory(v.Directory)
}
...
func (o *twoKeyBase) Directory() string {
	if o._restored && !o.directoryIsLoaded {
		panic("Directory was not selected in the last query and has not been set, and so is not valid")
	}
	return o.directory
}
...
func (o *twoKeyBase) update(ctx context.Context) error {
	...
	err := db.WithTransaction(ctx, d, func(ctx context.Context) error {
		...
		if len(modifiedFields) != 0 {
			err2 := d.Update(ctx, "two_key",
				map[string]any{
					"server":    o._originalPK.Server,
					"directory": o._originalPK.Directory,
				},
				modifiedFields,
				"",
				0,
...
func (o *twoKeyBase) insert(ctx context.Context) (err error) {
	...
	err = db.WithTransaction(ctx, d, func(ctx context.Context) error {
		...
		err = d.Insert(ctx, "two_key", insertFields, "")
		if err != nil {
			return err
		}
...
func (o *twoKeyBase) Delete(ctx context.Context) (err error) {
	...
	broadcast.Delete(ctx, "goradd_unit", "two_key", o._originalPK)
	return
}
...
func deleteTwoKey(ctx context.Context, pk TwoKeyPrimaryKey) error {
	...
	broadcast.Delete(ctx, "goradd_unit", "two_key", pk)
	return err
}
...
func (o *twoKeyBase) Get(key string) interface{} {
	switch key {
	case TwoKeyServerField:
		if !o.serverIsLoaded {
			return nil
		}
		return o.server
	case TwoKeyDirectoryField:
		if !o.directoryIsLoaded {
			return nil
		}
		return o.directory
	case TwoKeyFileNameField:
		if !o.fileNameIsLoaded {
			return nil
		}
		return o.fileName
