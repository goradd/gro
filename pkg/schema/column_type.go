...
//
// This is a unique value generated by the database or database driver when a record is inserted,
// and is represented in Go as a string, even though databases can use a variety of types for
// this internally, so that the data is easily moved to another database.
