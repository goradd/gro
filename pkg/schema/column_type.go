...
// # ColTypeAutoKey
//
// This is a key generated by the database or database driver,
// and is represented in Go as a string, even though databases can use a variety of types for
// a key internally. It is up to the database driver to ensure that the key is unique.
// If this is the only key column, then it will be the primary key. Otherwise, it will be part
// of a composite primary key, with the other fields manually specified.
//
// # ColTypeJSON
//
