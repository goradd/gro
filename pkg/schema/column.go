...
type Column struct {
	...
	// reference is the Reference associated with the column if it was generated by a reference
	reference *Reference
}
...
// Reference returns a reference associated with the column if this column was generated by a reference.
// Otherwise, returns nil.
func (c *Column) Reference() *Reference {
	return c.reference
}
