...
type AssociationTable struct {
	...
	// This will be used to create the corresponding Go identifier.
	Title2Plural string `json:"title2_plural"`
	...
	Identifier2Plural string `json:"identifier2_plural"`
}
