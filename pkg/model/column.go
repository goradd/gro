...
type Column struct {
	...
	Table *Table
	// Identifier is the name of the column in go code. e.g. "FirstName".
	Identifier string
	...
	// IsAutoPK is true if this column represents a unique identifier automatically generated by the database or database driver.
	IsAutoPK bool
	// IsPrimaryKey is true if this is a primary key column.
	IsPrimaryKey bool
...
func (cd *Column) HasDefaultValue() bool {
	return cd.IsAutoPK || cd.DefaultValue != nil
}
...
func newColumn(schemaCol *schema.Column) *Column {
	...
	col := &Column{
		...
		IsAutoPK:        schemaCol.Type == schema.ColTypeAutoPrimaryKey,
