...
type Reference struct {
	// Table is the name of the table on the other end of the foreign key.
	Table *Table
	// Column is the database column name in the linked table that matches this column name.
