...
func (tmpl *EnumTableTemplate) FileName(table *model.Enum) string {
	return filepath.Join("orm", table.DbKey, table.FileName()+".go")
}

func (tmpl *EnumTableTemplate) GenerateEnum(table *model.Enum, _w io.Writer, importPath string) (err error) {
...
func (tmpl *EnumTableTemplate) gen(table *model.Enum, _w io.Writer) (err error) {
...
func (tmpl *EnumTableTemplate) genHeader(table *model.Enum, _w io.Writer) (err error) {
...
func (tmpl *EnumTableTemplate) genConstants(table *model.Enum, _w io.Writer) (err error) {
...
func (tmpl *EnumTableTemplate) genString(table *model.Enum, _w io.Writer) (err error) {
...
func (tmpl *EnumTableTemplate) genId(table *model.Enum, _w io.Writer) (err error) {
...
func (tmpl *EnumTableTemplate) genPlurals(table *model.Enum, _w io.Writer) (err error) {
...
func (tmpl *EnumTableTemplate) genInterfaces(table *model.Enum, _w io.Writer) (err error) {
...
func (tmpl *EnumTableTemplate) genFields(table *model.Enum, _w io.Writer) (err error) {
