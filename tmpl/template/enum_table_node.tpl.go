...
func (tmpl *EnumTableNodeTemplate) gen(table *model.EnumTable, _w io.Writer) (err error) {
...
func (tmpl *EnumTableNodeTemplate) genHeader(table *model.EnumTable, _w io.Writer) (err error) {
...
func (tmpl *EnumTableNodeTemplate) genPrivate(table *model.EnumTable, _w io.Writer) (err error) {
...
func (tmpl *EnumTableNodeTemplate) genLeafNodes(table *model.EnumTable, _w io.Writer) (err error) {
