...
func (tmpl *EnumTableNodeTemplate) FileName(table *model.Enum) string {
	return filepath.Join("orm", table.DbKey, "node", table.FileName()+".go")
}

func (tmpl *EnumTableNodeTemplate) GenerateEnum(table *model.Enum, _w io.Writer, importPath string) (err error) {
...
func (tmpl *EnumTableNodeTemplate) gen(table *model.Enum, _w io.Writer) (err error) {
...
func (tmpl *EnumTableNodeTemplate) genHeader(table *model.Enum, _w io.Writer) (err error) {
...
func (tmpl *EnumTableNodeTemplate) genPrivate(table *model.Enum, _w io.Writer) (err error) {
...
func (tmpl *EnumTableNodeTemplate) genLeafNodes(table *model.Enum, _w io.Writer) (err error) {
